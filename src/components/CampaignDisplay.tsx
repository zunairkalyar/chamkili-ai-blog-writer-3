...
import { ImageState, ContentBlock, GeneratedCampaignAssets } from '../types';
        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 min-h-[60vh] flex items-center justify-center">
                 <div className="text-center text-gray-500">
                    <div className="w-16 h-16 border-4 border-brand-secondary border-dashed rounded-full animate-spin mx-auto mb-4"></div>
            ...
            <div className="p-4 border-b border-gray-200">
                 <div className="flex space-x-1 border-b-2 border-gray-100 overflow-x-auto pb-1">
                    <button 
                        ...
                        className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-t-lg transition-colors ${activeTab === 'blog' ? 'border-b-2 border-brand-primary text-brand-primary' : 'text-gray-500 hover:text-gray-800'}`}
                    >
                    ...
                    {campaignAssets?.social && (
                        <button 
                            ...
                            className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-t-lg transition-colors capitalize ${activeTab === 'social' ? 'border-b-2 border-brand-primary text-brand-primary' : 'text-gray-500 hover:text-gray-800'}`}
                        >
                     ...
                     {campaignAssets?.emails && (
                        <button 
                            ...
                            className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-t-lg transition-colors capitalize ${activeTab === 'email' ? 'border-b-2 border-brand-primary text-brand-primary' : 'text-gray-500 hover:text-gray-800'}`}
                        >
                     ...
                     {campaignAssets?.ads && (
                        <button 
                            ...
                            className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-t-lg transition-colors capitalize ${activeTab === 'ads' ? 'border-b-2 border-brand-primary text-brand-primary' : 'text-gray-500 hover:text-gray-800'}`}
                        >
