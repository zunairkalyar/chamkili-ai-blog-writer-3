  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-xl p-8 m-4 max-w-md w-full" onClick={e => e.stopPropagation()}>
        <h2 className="text-2xl font-bold font-serif text-brand-primary mb-4">Shopify Configuration</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-brand-primary focus:border-brand-primary"
              placeholder="shpat_..."
            />
        ...
        <div className="mt-8 flex justify-end space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-brand-secondary text-white rounded-md hover:bg-brand-primary disabled:bg-gray-400"
          >
            Save & Connect
          </button>
        </div>
