...
import { CalendarTopic } from '../services/gemini';
    ...
    return (
        <main className="container mx-auto px-4 py-8 md:py-12">
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-bold font-serif text-brand-primary">Your Content Command Center</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 text-center flex flex-col items-center">
                    <SitemapIcon className="w-12 h-12 text-brand-primary mb-4" />
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-brand-secondary text-white font-bold py-3 px-4 rounded-lg hover:bg-brand-primary transition-all transform hover:scale-105"
                    >
                        Go to Generator
                    </button>
                </div>
                 <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 text-center flex flex-col items-center">
                    <CalendarIcon className="w-12 h-12 text-brand-primary mb-4" />
            ...
            <div id="calendar-planner" className="pt-16 max-w-5xl mx-auto">
                 <div className="text-center mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold font-serif text-brand-primary">AI Content Calendar Planner</h2>
