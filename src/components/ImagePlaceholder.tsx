                ...
                <div className="p-3 bg-white border-t border-gray-200">
                    ...
                    <div className="flex items-center gap-2">
                         <textarea
                            ...
                            rows={3}
                            className="w-full text-sm p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-brand-primary focus:border-brand-primary resize-none transition-shadow duration-200"
                            placeholder="Enter image prompt..."
                        />
                        <button
                            onClick={() => onRetry(id)}
                            className="p-2.5 bg-brand-secondary text-white rounded-md hover:bg-brand-primary transition-colors self-stretch flex flex-col items-center justify-center"
