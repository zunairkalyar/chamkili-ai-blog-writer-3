...
import { TrendingTopicResult } from '../services/gemini';
                    ...
                    {result.topics.map((trend, index) => (
                        <div key={index} className="p-3 bg-gray-50/70 rounded-lg border border-gray-200">
                            ...
                            <button 
                                ...
                                className="text-xs font-bold text-white bg-brand-primary hover:bg-brand-secondary px-2 py-1 rounded-md flex items-center gap-1.5 transition-colors"
                            >
