        ...
        <div key={index} className="bg-white p-4 rounded-xl shadow-md border border-gray-200 transition-all hover:shadow-lg hover:border-purple-200">
          <div className="flex flex-col md:flex-row md:items-start gap-4">
            <div className="flex-shrink-0 text-center md:w-24">
               <p className="text-3xl font-bold font-serif text-brand-primary">{new Date(topic.date).getDate()}</p>
            ...
            <div className="flex-shrink-0 self-center">
              <button
                ...
                className="flex items-center justify-center gap-2 bg-brand-secondary text-white font-bold py-2 px-4 rounded-lg hover:bg-brand-primary transition-all transform hover:scale-105"
              >
