...
import { CampaignPlan } from '../services/gemini';
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 md:p-8 space-y-8">
            <div className="text-center">
                <MegaphoneIcon className="w-12 h-12 mx-auto text-brand-primary mb-2" />
                <h2 className="text-2xl font-bold font-serif text-brand-text-dark">Campaign Plan</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4 lg:col-span-1">
                    <h3 className="text-lg font-bold font-serif text-brand-text-dark border-b pb-2">Cornerstone Blog Post</h3>
                     <div className="space-y-3 max-h-[50vh] overflow-y-auto custom-scrollbar pr-2">
                        {plan.blogPostOutline.map((item) => (
                            <div key={item.id} className="p-3 bg-gray-50/70 rounded-lg border border-gray-200">
                                <h4 className="font-semibold text-md text-brand-primary">{item.heading}</h4>
                ...
                <div className="space-y-6 lg:col-span-1">
                     <div className="space-y-4">
                        <h3 className="text-lg font-bold font-serif text-brand-text-dark border-b pb-2">Social Media Posts</h3>
                        <div className="space-y-3 max-h-[50vh] overflow-y-auto custom-scrollbar pr-2">
                ...
                <div className="space-y-6 lg:col-span-1">
                     <div className="space-y-4">
                        <h3 className="text-lg font-bold font-serif text-brand-text-dark border-b pb-2">Email Drip Campaign</h3>
                        <div className="space-y-3 max-h-[50vh] overflow-y-auto custom-scrollbar pr-2">
                     ...
                     <div className="space-y-4">
                        <h3 className="text-lg font-bold font-serif text-brand-text-dark border-b pb-2">Ad Copy Variations</h3>
